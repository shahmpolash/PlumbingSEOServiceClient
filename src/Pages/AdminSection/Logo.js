...
const Logo = () => {
    ...
    const handleLogo = (event) => {
        ...
        const url = `https://plumbingseoservice-e14c7ccb325f.herokuapp.com/add-logo`;
        fetch(url, {
            method: "POST",
            headers: {
                                ...
                                <>
                                    {
                                        logo.map(c =>
                                            logo.map(c =>
                                                <Link className='th-btn' to={`/edit-logo/${c._id}`}> Please Edit Your Logo</Link>)
                                ...
                                <form class="contact-form " onSubmit={handleLogo}>
                                    ...
                                    <div className="col-lg-12 col-md-12">
                                        ...
                                        <div class="slider-btn">
                                            <button class="th-btn" data-animation="fadeInRight" data-delay=".8s">Update Your Logo</button>
                                        </div>
                                    </div>
