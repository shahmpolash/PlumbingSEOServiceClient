...
const EditStep = () => {
    ...
    useEffect(() => {
        fetch(`https://plumbingseoservice-e14c7ccb325f.herokuapp.com/step-item/${id}`)
            .then((res) => res.json())
    ...
    const handleStepSection = (event) => {
        ...
        const url = `https://plumbingseoservice-e14c7ccb325f.herokuapp.com/step-item/${step._id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                            ...
                            <form class="contact-form " onSubmit={handleStepSection}>
                                <div class="row">
                                    ...
                                    <div class="slider-btn">
                                        <button class="th-btn" data-animation="fadeInRight" data-delay=".8s"> Update Step </button>
                                    </div>
                                </div>
