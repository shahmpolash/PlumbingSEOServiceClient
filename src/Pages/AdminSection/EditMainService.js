...
const EditMainService = () => {
    ...
    useEffect(() => {
        fetch(`https://plumbingseoservice-e14c7ccb325f.herokuapp.com/service-item/${id}`)
            .then((res) => res.json())
    ...
    const handleAddItem = (event) => {
        ...
        const url = `https://plumbingseoservice-e14c7ccb325f.herokuapp.com/service-item/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
            ...
            <form class="contact-form" onSubmit={handleAddItem}>
                <div class="row">
                    ...
                    <div class="slider-btn">
                        <button class="th-btn" data-animation="fadeInRight" data-delay=".8s"> Update Main service </button>
                    </div>
                </div>
