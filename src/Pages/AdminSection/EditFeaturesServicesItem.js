...
const EditFeaturesServicesItem = () => {
    ...
    useEffect(() => {
        fetch(`https://plumbingseoservice-e14c7ccb325f.herokuapp.com/featureitems/${id}`)
            .then((res) => res.json())
    ...
    const handleItemSection = (event) => {
        ...
        const url = `https://plumbingseoservice-e14c7ccb325f.herokuapp.com/update-featureitems/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                                ...
                                <form class="contact-form " onSubmit={handleItemSection}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="th-btn" data-animation="fadeInRight" data-delay=".8s"> Update Feature </button>
                                        </div>
                                    </div>
