...
const ServicesSection = () => {
    ...
    const handleServiceSection = (event) => {
        ...
        const url = `https://plumbingseoservice-e14c7ccb325f.herokuapp.com/add-Service`;
        fetch(url, {
            method: "POST",
            headers: {
    ...
    const handleAddItem = (event) => {
        ...
        const url = `https://plumbingseoservice-e14c7ccb325f.herokuapp.com/add-service-item`;
        fetch(url, {
            method: "POST",
            headers: {
                "content-type": "application/json",
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-12">
                            <h2 className='mt-5'> Update Service </h2>
                            {
                                service.length === 1 &&
                                <> {
                                    service.map(s => <Link className='th-btn' to={`/servicetext-edit/${s._id}`}>Update Service</Link>)
                                }</>
                                ...
                                <form class="contact-form " onSubmit={handleServiceSection}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="th-btn" data-animation="fadeInRight" data-delay=".8s"> Update Services </button>
                                        </div>
                                    </div>
                            ...
                            <form class="contact-form" onSubmit={handleAddItem}>
                                <div class="row">
                                    ...
                                    <div class="slider-btn">
                                        <button class="th-btn" data-animation="fadeInRight" data-delay=".8s"> Add Service </button>
                                    </div>
                                </div>
