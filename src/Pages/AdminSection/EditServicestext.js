...
const EditServicestext = () => {
    ...
    useEffect(() => {
        fetch(`https://plumbingseoservice-e14c7ccb325f.herokuapp.com/service/${id}`)
            .then((res) => res.json())
    ...
    const handleServiceText = (event) => {
        ...
        const url = `https://plumbingseoservice-e14c7ccb325f.herokuapp.com/service/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                                    ...
                                    <div class="row">
                                        ...
                                        <div className="col-lg-12 col-md-12">
                                         ...
                                         <div class="slider-btn">
                                            <button class="th-btn" data-animation="fadeInRight" data-delay=".8s"> Update Services Text</button>
                                        </div>
                                    </div>
