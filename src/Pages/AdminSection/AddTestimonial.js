...
const AddTestimonial = () => {
    ...
    const handleTestimonialSection = (event) => {
        ...
        const url = `https://plumbingseoservice-e14c7ccb325f.herokuapp.com/add-testimonial-text`;
        fetch(url, {
            method: "POST",
            headers: {
    ...
    const handleStepSection = (event) => {
        ...
        const url = `https://plumbingseoservice-e14c7ccb325f.herokuapp.com/add-testimonial`;
        fetch(url, {
            method: "POST",
            headers: {
                "content-type": "application/json",
                    ...
                    <div class="col-lg-8 col-md-12">
                        ...
                        <h3 className='mt-5'> Update Testimonial Text </h3>
                        {
                            ...
                            <>
                                {testimonialtext.map(text =>
                                    <Link className='th-btn' to={`/testimonialtext-edit/${text._id}`}> Update Now</Link>
                                )}
                            </>
                        }
                            ...
                            <form class="contact-form " onSubmit={handleTestimonialSection}>
                                <div class="row">
                                    ...
                                    <div class="slider-btn">
                                        <button class="th-btn" data-animation="fadeInRight" data-delay=".8s"> Update Testimonial Text </button>
                                    </div>
                                </div>
                        ...
                        <form class="contact-form " onSubmit={handleStepSection}>
                            <div class="row">
                                ...
                                <div class="slider-btn">
                                    <button class="th-btn" data-delay=".8s"> Add Testimonial</button>
                                </div>
                            </div>
                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="section-title center-align text-center mb-50">
                            ...
                            <h3 className='mt-5'>Testimonial List</h3>
                        </div>
                    </div>
                </div>
