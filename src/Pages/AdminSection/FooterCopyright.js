...
const FooterCopyright = () => {
    ...
    const handleFooterCopyright = (event) => {
        ...
        const url = `https://plumbingseoservice-e14c7ccb325f.herokuapp.com/add-footer-copyright`;
        fetch(url, {
            method: "POST",
            headers: {
                                ...
                                <>
                                    {
                                        footercopyright.map(c =>
                                            footercopyright.map(c =>
                                                <Link className='th-btn' to={`/edit-copyright/${c._id}`}> Please Edit About Footer</Link>)
                                ...
                                <form class="contact-form " onSubmit={handleFooterCopyright}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="th-btn" data-animation="fadeInRight" data-delay=".8s"> Update Footer Copyright</button>
                                        </div>
                                    </div>
