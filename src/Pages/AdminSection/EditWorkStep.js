...
const EditWorkStep = () => {
    ...
    useEffect(() => {
        fetch(`https://plumbingseoservice-e14c7ccb325f.herokuapp.com/worksec/${id}`)
            .then((res) => res.json())
    ...
    const handleBannerSection = (event) => {
        ...
        const url = `https://plumbingseoservice-e14c7ccb325f.herokuapp.com/update-worksec/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                                ...
                                <form class="contact-form " onSubmit={handleBannerSection}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="th-btn" data-animation="fadeInRight" data-delay=".8s">Update Work section</button>
                                        </div>
                                    </div>
