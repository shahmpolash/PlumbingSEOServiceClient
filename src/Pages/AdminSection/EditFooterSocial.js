...
const EditFooterSocial = () => {
    ...
    useEffect(() => {
        fetch(`https://plumbingseoservice-e14c7ccb325f.herokuapp.com/footer-social/${id}`)
            .then((res) => res.json())
    ...
    const handleFootersocial = (event) => {
        ...
        const mainAbout = event.target.mainAbout.value;
        ...
        const url = `https://plumbingseoservice-e14c7ccb325f.herokuapp.com/footer-social/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                        ...
                        <div class="col-lg-8 col-md-12">
                            ...
                            <form class="contact-form " onSubmit={handleFootersocial}>
                                <div class="row">
                                    ...
                                    <div className="col-lg-12 col-md-12">
                                        <div className="form-group">
                                            <input type="text" className="form-control" name="mainAbout" defaultValue={footersocial.mainAbout} placeholder="Main About Text Your Company" required />
                                        </div>
                                    </div>
                                    <div className="col-lg-12 col-md-12">
                                        <div className="form-group">
                                    ...
                                    <div class="slider-btn">
                                        <button class="th-btn" data-delay=".8s"> Update Footer</button>
                                    </div>
                                </div>
