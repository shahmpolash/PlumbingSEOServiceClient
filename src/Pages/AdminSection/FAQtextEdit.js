...
const FAQtextEdit = () => {
    ...
    useEffect(() => {
        fetch(`https://plumbingseoservice-e14c7ccb325f.herokuapp.com/faq/${id}`)
            .then((res) => res.json())
    ...
    const handleFAQText = (event) => {
        ...
        const url = `https://plumbingseoservice-e14c7ccb325f.herokuapp.com/faq/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                                ...
                                <form class="contact-form " onSubmit={handleFAQText}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="th-btn" data-animation="fadeInRight" data-delay=".8s"> Update FAQ Text </button>
                                        </div>
                                    </div>
