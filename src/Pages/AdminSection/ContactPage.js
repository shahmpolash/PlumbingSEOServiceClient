...
const ContactPage = () => {
    ...
    useEffect(() => {
        fetch(`https://plumbingseoservice-e14c7ccb325f.herokuapp.com/contacts`)
            .then((res) => res.json())
    ...
    const handleContactSection = (event) => {
        ...
        const url = `https://plumbingseoservice-e14c7ccb325f.herokuapp.com/add-contact`;
        fetch(url, {
            method: "POST",
            headers: {
                            ...
                            <form class="contact-form " onSubmit={handleContactSection}>
                                <div class="row">
                                    ...
                                    <div class="slider-btn">
                                        <button class="th-btn" data-delay=".8s"> Add Contcat Details</button>
                                    </div>
                                </div>
