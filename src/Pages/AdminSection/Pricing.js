...
const Pricing = () => {
    ...
    const handlePricing = (event) => {
        ...
        const url = `https://plumbingseoservice-e14c7ccb325f.herokuapp.com/add-pricing`;
        fetch(url, {
            method: "POST",
            headers: {
                                ...
                                <form class="contact-form " onSubmit={handlePricing}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="th-btn" data-delay=".8s"> Add Package</button>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="pricingTable">
                                        ...
                                        <div class="price-value">
                                            ${pri.packagePrice}/<span>month</span>
                                        </div>
                                        <div class="pricingTable-signup">
                                            <Link to={`/package-edit/${pri._id}`} className='btn btn-primary'>Edit Pricing</Link>
                                        </div>
                                    </div>
                                </div>
                            )}
