                   ...
                   <div className='container align-items-center justify-content-center mt-5'>
                       ...
                       <div class="container text-center">
                           <div class="row">
                               ...
                               <div class="col-lg-3  col-md-6 col-12">
                                   <div className='single-card'>
                                       <Link to='/edit-work'>  <img src={timeline} /> Work Step</Link>
                                   </div>
                               ...
                               <div class="col-lg-3  col-md-6 col-12">
                                   <div className='single-card'>
                                       <Link to='/add-pricing'><img src={pri} /> Pricing Setting</Link>
                                   </div>
                               ...
                               <div class="col-lg-3  col-md-6 col-12">
                                   ...
                                   <div className='single-card'>
                                       <Link to='/edit-services-features'>  <img src={features} /> Features Section</Link>
                                   </div>
                               </div>
                               <div class="col-lg-3  col-md-6 col-12">

                                   <div className='single-card'>
                                       <Link to='/edit-team-text'>  <img src={team} /> Team Members</Link>
                                   </div>
                               </div>
                               <div class="col-lg-3  col-md-6 col-12">

                                   <div className='single-card'>
                                       <Link to='/edit-experience'>  <img src={quality} /> Skill Section</Link>
                                   </div>
                               </div>
                               <div class="col-lg-3  col-md-6 col-12">
