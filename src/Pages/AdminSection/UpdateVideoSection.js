...
const UpdateVideoSection = () => {
    ...
    useEffect(() => {
        fetch(`https://plumbingseoservice-e14c7ccb325f.herokuapp.com/videos-items/${id}`)
            .then((res) => res.json())
    ...
    const handleVideoSection = (event) => {
        ...
        const url = `https://plumbingseoservice-e14c7ccb325f.herokuapp.com/videos-items/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
