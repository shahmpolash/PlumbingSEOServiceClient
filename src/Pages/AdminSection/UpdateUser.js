...
const UpdateUser = () => {
    ...
    useEffect(() => {
        fetch(`https://plumbingseoservice-e14c7ccb325f.herokuapp.com/users/${id}`)
            .then((res) => res.json())
    ...
    const handleUser = (event) => {
        ...
        const url = `https://plumbingseoservice-e14c7ccb325f.herokuapp.com/upadete-users/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="slider-btn ">
                                        <button class="th-btn" data-animation="fadeInRight" data-delay=".8s"> Update User Email </button>
