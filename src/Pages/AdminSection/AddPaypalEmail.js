...
const AddPaypalEmail = () => {
    ...
    useEffect(() => {
        fetch(`https://plumbingseoservice-e14c7ccb325f.herokuapp.com/paypal-email`)
            .then((res) => res.json())
    ...
    const handleEmailSection = (event) => {
        ...
        const url = `https://plumbingseoservice-e14c7ccb325f.herokuapp.com/add-email`;
        fetch(url, {
            method: "POST",
            headers: {
                           ...
                           <div class="row">
                               <div class="col-lg-12">
                                   ...
                                   <div class="slider-btn ">
                                       <button class="th-btn" data-animation="fadeInRight" data-delay=".8s"> Add Paypal Email </button>
