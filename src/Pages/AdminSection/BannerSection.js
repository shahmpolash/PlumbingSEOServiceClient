...
const BannerSection = () => {
    ...
    const handleBannerSection = (event) => {
        ...
        const url = `https://plumbingseoservice-e14c7ccb325f.herokuapp.com/add-banner`;
        fetch(url, {
            method: "POST",
            headers: {
                                    ...
                                    <>
                                        {
                                            banner.map(c =>
                                                banner.map(c =>
                                                    <Link className='th-btn' to={`/banner/${c._id}`}> Edit Banner Section</Link>)
                                            )
                                        }
                                    </>
                                }
                                    ...
                                    <form class="contact-form " onSubmit={handleBannerSection}>
                                        <div class="row">
                                            ...
                                            <div class="slider-btn">
                                                <button class="th-btn" data-animation="fadeInRight" data-delay=".8s">Add Banner</button>
                                            </div>
                                        </div>
