...
const PaypalEmail = () => {
    ...
    useEffect(() => {
        fetch(`https://plumbingseoservice-e14c7ccb325f.herokuapp.com/paypal-email/${id}`)
            .then((res) => res.json())
    ...
    const handleUpdatePaypal = (event) => {
        ...
        const url = `https://plumbingseoservice-e14c7ccb325f.herokuapp.com/paypal-email/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                            ...
                            <form class="contact-form " onSubmit={handleUpdatePaypal}>
                                <div class="row">
                                    ...
                                    <div class="slider-btn">
                                        <button class="th-btn" data-animation="fadeInRight" data-delay=".8s"> Update Now</button>
                                    </div>
                                </div>
