...
const EditFooterabout = () => {
    ...
    useEffect(() => {
        fetch(`https://plumbingseoservice-e14c7ccb325f.herokuapp.com/footer-about/${id}`)
            .then((res) => res.json())
    ...
    const handleFooterAbout = (event) => {
        ...
        const url = `https://plumbingseoservice-e14c7ccb325f.herokuapp.com/footer-about/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                            ...
                            <form class="contact-form " onSubmit={handleFooterAbout}>
                                <div class="row">
                                    ...
                                    <div class="slider-btn">
                                        <button class="th-btn" data-animation="fadeInRight" data-delay=".8s"> Update Footer About</button>
                                    </div>
                                </div>
