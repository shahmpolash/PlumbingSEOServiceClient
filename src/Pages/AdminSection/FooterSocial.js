...
const FooterSocial = () => {
    ...
    const handleFootersocial = (event) => {
        ...
        const url = `https://plumbingseoservice-e14c7ccb325f.herokuapp.com/add-footer-social`;
        fetch(url, {
            method: "POST",
            headers: {
                                ...
                                <>
                                    {
                                        footersocial.map(c =>
                                            footersocial.map(c =>
                                                <Link className='th-btn' to={`/edit-social-footer/${c._id}`}> Edit Social URL </Link>)
                            ...
                            }
                            {
                                ...
                                <form class="contact-form " onSubmit={handleFootersocial}>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="contact-field p-relative c-name mb-20">
                                                <input type="text" name="mainAbout" placeholder=" Main About Text for Company" required />
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="contact-field p-relative c-name mb-20">
                                        ...
                                        <div class="slider-btn">
                                            <button class="th-btn" data-delay=".8s"> Add Footer Social </button>
                                        </div>
                                    </div>
