...
const EditVideoText = () => {
    ...
    useEffect(() => {
        fetch(`https://plumbingseoservice-e14c7ccb325f.herokuapp.com/videos/${id}`)
            .then((res) => res.json())
    ...
    const handleVideoText = (event) => {
        ...
        const url = `https://plumbingseoservice-e14c7ccb325f.herokuapp.com/update-videos/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                                ...
                                <form class="contact-form " onSubmit={handleVideoText}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="th-btn" data-animation="fadeInRight" data-delay=".8s"> Update Video Text</button>
                                        </div>
                                    </div>
