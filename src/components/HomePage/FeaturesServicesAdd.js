...
const FeaturesServicesAdd = () => {
    ...
    useEffect(() => {
        fetch(`https://plumbingseoservice-e14c7ccb325f.herokuapp.com/featurestext`)
            .then((res) => res.json())
            .then((info) => setFeaturesText(info));
    }, []);

    useEffect(() => {
        fetch(`https://plumbingseoservice-e14c7ccb325f.herokuapp.com/featureitems`)
            .then((res) => res.json())
    ...
    const handleFeaturesTextSection = (event) => {
        ...
        const url = `https://plumbingseoservice-e14c7ccb325f.herokuapp.com/add-feature-text`;
        fetch(url, {
            method: "POST",
            headers: {
    ...
    const handleItemSection = (event) => {
        ...
        const url = `https://plumbingseoservice-e14c7ccb325f.herokuapp.com/add-feature-Item`;
        fetch(url, {
            method: "POST",
            headers: {
                "content-type": "application/json",
                            ...
                            <div class="col-lg-8 col-md-12">
                                ...
                                <h3 className='mt-5'> Update Features Services Text </h3>
                                {
                                    ...
                                    <>
                                        {featurestext.map(text =>
                                            <Link className='th-btn' to={`/featurestext-edit/${text._id}`}> Update Now</Link>
                                        )}
                                    </>
                                }
                                    ...
                                    <form class="contact-form " onSubmit={handleFeaturesTextSection}>
                                        <div class="row">
                                            ...
                                            <div class="slider-btn">
                                                <button class="th-btn" data-animation="fadeInRight" data-delay=".8s"> Add Features Text </button>
                                            </div>
                                        </div>
                                ...
                                <form class="contact-form " onSubmit={handleItemSection}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="th-btn" data-delay=".8s"> Add Features Item</button>
                                        </div>
                                    </div>
                                ...
                                featureitems.map(s => <div className="col-md-6 col-lg-4">
                                    <div className="feature-card wow fadeInUp">
                                        ...
                                        <div className="feature-card_content">
                                            ...
                                            <Link to={`/edit-feature-items/${s._id}`}><h3 className="box-title" class="th-btn">Edit Now</h3></Link>
